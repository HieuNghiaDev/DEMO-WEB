    ...
    <header className="px-4 pb-4 pt-5 sm:px-5 lg:px-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <button
          ...
          disabled={refreshing}
          onClick={onRefresh}
          className="inline-flex h-10 shrink-0 items-center justify-center gap-2 self-start rounded-lg border border-slate-300 bg-white px-4 text-sm font-medium text-slate-700 transition-colors duration-150 hover:border-indigo-300 hover:bg-indigo-50 hover:text-indigo-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 disabled:cursor-wait disabled:opacity-60 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:border-indigo-400/50 dark:hover:bg-indigo-500/10 dark:hover:text-indigo-200 dark:focus-visible:ring-offset-slate-950"
        >
          <RefreshCw size={15} className={refreshing ? 'animate-spin' : 'text-indigo-500 dark:text-indigo-300'} aria-hidden="true" />
  ...
  return (
    <div className="mt-4 flex min-w-0 flex-col gap-2.5 border-t border-slate-100 pt-3.5 dark:border-slate-800 lg:flex-row lg:items-center lg:justify-between lg:gap-5">
      <div className="flex min-w-0 items-center gap-2.5">
        <Cloud size={16} className="shrink-0 text-indigo-500 dark:text-indigo-300" aria-hidden="true" />
