  ...
  return <>
    ...
    <aside ref={sidebarRef} id="main-sidebar" aria-label={t('sidebar.mainMenu')}
      ...
      <div className="flex shrink-0 items-center gap-3 px-1 py-2">
        ...
        <button type="button" onClick={closeMenu} aria-label={t('sidebar.closeMenu')} className="rounded-md p-2 text-slate-500 hover:bg-slate-100 focus-visible:ring-2 focus-visible:ring-indigo-500 dark:hover:bg-slate-800 md:hidden"><X size={18} /></button>
      </div>
      <SidebarUtilityPanel />
